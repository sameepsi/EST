...
contract ESTTokenSale is Ownable{
      ...
      //rate of token : 0.00005804 ETH = 1 EST
   ...
   */
   ...
   functiomn endSale() public onlyOwner _contractUp _saleNotEnded {
  ...
  */
  function setTiersInfo(uint8 _noOfPhases, uint256[] _startTimes, uint256[] _endTimes, uint256[] _cummulativeHardCaps, uint8[4] _bonusPercentages)private {
    ...
    */  
    constructor (address _tokenToBeUsed, address _wallet)public nonZeroAddress(_tokenToBeUsed) nonZeroAddress(_wallet){
        ...
        //pre-sales
        startTimes[0] = 1529592480; //JULY 01, 2018 12:00:00 AM GMT
        endTimes[0] = 1529592600; //AUGUST 31, 2018 11:59:59 PM GMT
        cummulativeHardCaps[0] = 2107040600000000000000 wei;
        bonusPercentages[0] = 67;
        
        //phase-1
        startTimes[1] = 1529592720; //SEPTEMBER 02, 2018 12:00:00 AM GMT 
        endTimes[1] = 1529593140; //OCTOBER 15, 2018 11:59:59 PM GMT
        cummulativeHardCaps[1] = 7766345900000000000000 wei;
        bonusPercentages[1] = 33;
        
        
        //phase-2
        startTimes[2] = 1539691200; //OCTOBER 16, 2018 12:00:00 AM GMT
        endTimes[2] = 1543579199; //NOVEMBER 30, 2018 11:59:59 PM GMT
        cummulativeHardCaps[2] = 14180545900000000000000 wei;
        bonusPercentages[2] = 18;
        
        //phase-3
        startTimes[3] = 1543665600; //DECEMBER 01, 2018 12:00:00 AM GMT
        endTimes[3] = 1546257599; //DECEMBER 31, 2018 11:59:59 PM GMT
   ...
   */
    ...
    * @param percentage Array of bonus percentages for the phase as per ethers sent
    */
